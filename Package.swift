...
if useLocalFFI {
    ...
    targets.append(
        .binaryTarget(
            name: "libzcashlc",
            url: "https://github.com/zcash/zcash-swift-wallet-sdk/releases/download/2.6.0-alpha.4/libzcashlc.xcframework.zip",
            checksum: "1002bc05ad71eb1e154141bcf48fc848c3d8e7c8fc2d0ce537d7bf34d025f7d3"
        )
    )
